"""Shared test fixtures and helpers for BridgeEscrow tests."""
...
def tmp_data_dir(tmp_path):
    """Create a temporary data directory with empty JSON files."""
...
def patched_db(tmp_data_dir, monkeypatch):
    """Patch core.database to use the temp data directory."""
...
def sample_user(patched_db):
    """Create and return a sample BUYER user."""
...
def sample_retailer(patched_db):
    """Create and return a sample RETAILER user."""
    from core.models import User
...
def sample_delivery(patched_db):
    """Create and return a sample DELIVERY user."""
    from core.models import User
...
def sample_trustee(patched_db):
    """Create and return a sample TRUSTEE user."""
    from core.models import User
